-- ============================================
-- INSERIR DADOS NO SUPABASE - SEM ORGANIZATION_ID
-- ============================================
-- Este SQL não usa organization_id nas tabelas que não têm
...
-- ============================================
-- 3. INSERIR SERVIÇOS (SEM organization_id)
-- ============================================
...
-- ============================================
-- 4. INSERIR PROFISSIONAIS (SEM organization_id)
-- ============================================
...
-- ============================================
-- 5. INSERIR AGENDAMENTOS (SEM organization_id)
-- ============================================

INSERT INTO appointments (
  client_id, pet_id, service_id, professional_id,
  appointment_date, start_time, duration_minutes, status, notes, send_email
) VALUES
  (
    (SELECT id FROM clientes WHERE cpf = '12345678901' LIMIT 1),
